...
<table>
    ...
    <tbody>
        ...
        <tr><td>2</td><td>WAP in C to find time complexity of Insertion Sort by using RAM Model.</td><td>10 March, 2026</td><td>before practical date</td></tr>
        <tr><td>3</td><td>WAP in C to find time complexity of Selection Sort using RAM Model.</td><td>10 March, 2026</td><td>before practical date</td></tr>
        <tr><td>4</td><td>WAP in C to find GCD of given two numbers.</td><td>10 March 2026</td><td>before practical date</td></tr>
        <tr><td>5</td><td>WAP in C to sort given numbers using Merge Sort and find execution time by using clock function.</td><td>10 March 2026</td><td>before practical date</td></tr>
        <tr><td>6</td><td>WAP in C to sort given numbers by using Quick Sort and find execution time by using clock function</td><td>March 2026</td><td>before practical date</td></tr>
        ...
        <tr><td>8</td><td>WAP in C to sort given numbers by using Randomized Quick Sort and find execution time by using clock function</td><td>March 2026</td><td>before practical date</td></tr>
        ...
        <tr><td>13</td><td>WAP in C to find shortest path by using FLoyd Warshall algorithm (all pair).</td><td>March 2026</td><td>before practical date</td></tr>
        ...
        <tr><td>19</td><td>WAP in C to selct subset sum by using backtracking algorithm</td><td>March 2026</td><td>before pracical date</td></tr>
